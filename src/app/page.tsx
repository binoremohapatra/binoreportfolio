...
export default function Home() {
  return (
    <main className="min-h-screen bg-[var(--bg-dark)]">
      ...
      <section className="pt-20 sm:pt-32 pb-16 sm:pb-24 overflow-hidden relative z-20 bg-[var(--bg-primary)]">
        ...
        <div
          ...
          style={{ background: 'radial-gradient(ellipse at top left, var(--bg-secondary) 0%, transparent 70%)' }}
        />
        <div
          className="absolute top-0 right-0 w-[200px] md:w-[400px] h-[200px] md:h-[300px] pointer-events-none opacity-40"
          style={{ background: 'radial-gradient(ellipse at top right, var(--bg-secondary) 0%, transparent 70%)' }}
        />



        <div className="relative z-10 mb-16 text-center px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-mono font-bold tracking-[0.15em] sm:tracking-[0.2em] uppercase" style={{ color: 'var(--text-primary)' }}>Core Stack</h2>
        ...
        <div
          style={{
            // All icons render as monochrome light silhouettes at rest;
            // hover state transitions them to the accent color via .logoloop__item:hover svg
